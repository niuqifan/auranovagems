...
const products = [
  {id:1,name:'Rose Quartz Bracelet',intention:'Love',chakra:'Heart',zodiac:'Taurus',crystal:'Rose Quartz',shape:'Bracelet',moq:50,icon:'♡',grad:'linear-gradient(135deg,#fff1f5,#eaa2ba)',img:'https://sc02.alicdn.com/kf/Ac0da74b137964f5cabb43a503776752ej.png',desc:'A gentle heart-opening bracelet for love, compassion and emotional healing.'},
  {id:2,name:'Amethyst Bracelet',intention:'Calm',chakra:'Crown',zodiac:'Pisces',crystal:'Amethyst',shape:'Bracelet',moq:50,icon:'●',grad:'linear-gradient(135deg,#ead9ff,#74369b)',img:'https://sc02.alicdn.com/kf/Acb2addb8d20e43c2aab2cbb4942151b4p.png',desc:'A calming amethyst bracelet for meditation, sleep and spiritual clarity.'},
  {id:3,name:'Citrine Bracelet',intention:'Abundance',chakra:'Solar Plexus',zodiac:'Leo',crystal:'Citrine',shape:'Bracelet',moq:50,icon:'◎',grad:'linear-gradient(135deg,#fff3b9,#d48a21)',img:'https://sc02.alicdn.com/kf/A5b9332f126744f539316db1873a95f9dk.png',desc:'A bright prosperity bracelet for confidence, success and wealth energy.'},
  {id:4,name:'Black Obsidian Bracelet',intention:'Protection',chakra:'Root',zodiac:'Scorpio',crystal:'Obsidian',shape:'Bracelet',moq:50,icon:'●',grad:'linear-gradient(135deg,#3a3040,#050505)',img:'https://sc02.alicdn.com/kf/A3e84b2fe425d4888b32be64f2367715bW.png',desc:'A grounding protection bracelet for shielding negative energy.'},
  {id:5,name:'Amethyst Tower',intention:'Spirituality',chakra:'Crown',zodiac:'Aquarius',crystal:'Amethyst',shape:'Tower',moq:30,icon:'◭',grad:'linear-gradient(135deg,#f4dcff,#682c8c,#26113b)',img:'https://sc02.alicdn.com/kf/A1d7e71988343492286c1dc38420a2af3U.png',desc:'A polished amethyst tower for altar decor, meditation and spiritual work.'},
  {id:6,name:'Rose Quartz Sphere',intention:'Love',chakra:'Heart',zodiac:'Libra',crystal:'Rose Quartz',shape:'Sphere',moq:20,icon:'●',grad:'linear-gradient(135deg,#fff5f7,#e49ab2,#fff)',img:'https://sc02.alicdn.com/kf/Add78410e757b4539ad4a3b60437ed15ak.png',desc:'A soft rose quartz sphere for love rituals, display and emotional balance.'},
  {id:7,name:'Clear Quartz Point',intention:'New Beginnings',chakra:'Crown',zodiac:'Gemini',crystal:'Clear Quartz',shape:'Tower',moq:50,icon:'◭',grad:'linear-gradient(135deg,#fff,#d9f1ff,#b9b6d7)',img:'https://sc02.alicdn.com/kf/Ada6be8792d274871950cf99416455c60d.png',desc:'A high-clarity quartz point for cleansing, amplification and intention setting.'},
  {id:8,name:'Tiger Eye Palm Stone',intention:'Confidence',chakra:'Solar Plexus',zodiac:'Capricorn',crystal:'Tiger Eye',shape:'Palm Stone',moq:100,icon:'◒',grad:'linear-gradient(135deg,#3d2814,#d79b3a,#6b3e18)',img:'https://sc02.alicdn.com/kf/A1358180a8e934cdc94223d6f7b57b780O.png',desc:'A polished palm stone for courage, focus and personal power.'},
  {id:9,name:'Moonstone Necklace',intention:'Calm',chakra:'Third Eye',zodiac:'Cancer',crystal:'Moonstone',shape:'Necklace',moq:80,icon:'☾',grad:'linear-gradient(135deg,#fff,#cfd9ea,#f6e2ff)',img:'https://sc02.alicdn.com/kf/A51559cb5370447adbcdc50444c9b0d2fO.png',desc:'A luminous moonstone necklace for intuition, calm and feminine energy.'},
  {id:10,name:'Chakra Crystal Set',intention:'Spirituality',chakra:'Crown',zodiac:'Virgo',crystal:'Mixed Stones',shape:'Set',moq:100,icon:'◉',grad:'linear-gradient(135deg,#e94747,#f39c34,#f7dc53,#55c776,#3ab3d9,#6d5bd7,#9c55c7)',img:'https://sc02.alicdn.com/kf/A8301cb6fc6c94afba8014114b17d51283.png',desc:'A complete seven chakra set for meditation, gifting and wellness retail.'},
];
...
function renderProducts(list){ $('#productGrid').innerHTML=list.map(p=>`<article class="product-card"><div class="product-img" style="--grad:${p.grad}; ${p.img ? \`background-image:url(${p.img}); background-size:cover; background-position:center;\` : ''}">${p.img ? '' : p.icon}</div><h3>${p.name}</h3><p>${p.intention} • ${p.chakra} Chakra<br>${p.crystal} • MOQ ${p.moq} pcs</p><div class="card-actions"><button data-view="${p.id}">View Details</button><button data-add="${p.id}">Add to Inquiry</button></div></article>`).join('') || '<p>No matching products found.</p>'; }
